...
<section class="p-b-55">
    <div class="row align-items-center" style="height: 600px; background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url('images/bg3.jpg') no-repeat; background-size: cover;">
        <div class="col text-center">
            <h1 class="text-white" style="font-size: 60px;">RM AMPERA</h1>
            <p class="text-white" style="font-size: 25px;">Your Hungry Solution</
            </div>
        </div>
    </section>
    <!-- END WELCOME-->
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h2>Sekilas Info</h2>
                            <hr>
                            RM AMPERA merupakan solusi terbaik saat kondisi perut tidak kondusif, RM AMPERA memberi inovasi baru agar pelanggan setia tetap dapat menimkati masakan andalan RM Ampera di masa pandemi dengan fitur pesan online. 
                        </div>
                    </div>
                </div>
            </div>
